...
ActiveRecord::Schema.define(version: 2017_01_06_024818) do
  ...
  create_table "ccr_performance_reports", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["contract_id"], name: "index_ccr_performance_reports_on_contract_id"
    t.index ["department_id"], name: "index_ccr_performance_reports_on_department_id"
    t.index ["supplier_id"], name: "index_ccr_performance_reports_on_supplier_id"
  end
  ...
  create_table "contract_value_types", id: :serial, force: :cascade do |t|
  ...
  create_table "cpr_performance_reports", id: :serial, force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "supplier_id"
    t.index ["supplier_id"], name: "index_cpr_performance_reports_on_supplier_id"
  end
  ...
  create_table "csr_contracts", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "supplier_id"
    t.index ["supplier_id"], name: "index_csr_contracts_on_supplier_id"
  end

  create_table "csr_performance_reports", id: :serial, force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "supplier_id"
    t.index ["supplier_id"], name: "index_csr_performance_reports_on_supplier_id"
  end
  ...
  create_table "location_codes", id: :serial, force: :cascade do |t|
    t.string "code"
  ...
  create_table "unspscs", id: :serial, force: :cascade do |t|
